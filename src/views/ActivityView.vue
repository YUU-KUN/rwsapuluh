<template>
    <div class="px-6 laptop:px-40">
        ...
        <div class="grid grid-cols-1 laptop:grid-cols-3 gap-4 w-full mb-6 laptop:mb-40">
            <div @click="detailActivity(id)" v-for="{id, title, image_url, description, categories, created_at} in activities" :key="id" class="rounded-2xl bg-white p-6 text-left laptop:px-6 laptop:py-9 hover:cursor-pointer">
